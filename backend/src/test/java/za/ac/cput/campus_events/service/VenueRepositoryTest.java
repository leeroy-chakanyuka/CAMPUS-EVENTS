...
class VenueServiceTest {
    ...
    void testFindById_ExistingId_ShouldReturnVenue() {
        ...
        Optional<Venue> result = venueService.findById(1L);
    ...
    void testFindById_NonExistingId_ShouldReturnEmpty() {
        ...
        Optional<Venue> result = venueService.findById(99L);
    ...
    void testFindByName_ShouldReturnList() {
        ...
        List<Venue> result = venueService.findByName("Hall B");
    ...
    void testFindByCapacityGreaterThan_ShouldReturnList() {
        ...
        List<Venue> result = venueService.findByCapacityGreaterThan(100);
    ...
    void testFindByCity_ShouldReturnList() {
        ...
        List<Venue> result = venueService.findByCity("Cape Town");
